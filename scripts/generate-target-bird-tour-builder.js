...
body[data-page-type="target_bird_tour_builder"] .targetHero{display:grid;grid-template-columns:minmax(0,1fr) 320px;gap:18px;align-items:stretch;padding:26px;background:linear-gradient(135deg,rgba(255,255,255,.84),rgba(255,255,255,.56))}
body[data-page-type="target_bird_tour_builder"] .targetHeroCopy,body[data-page-type="target_bird_tour_builder"] .targetMiniReport,body[data-page-type="target_bird_tour_builder"] .filterPanel,body[data-page-type="target_bird_tour_builder"] .targetMain,body[data-page-type="target_bird_tour_builder"] .selectedPanel,body[data-page-type="target_bird_tour_builder"] .infoBox{border:1px solid var(--line);border-radius:var(--r);background:rgba(255,255,255,.68);box-shadow:var(--shadow)}
body[data-page-type="target_bird_tour_builder"] .targetHeroCopy{padding:22px;display:grid;align-content:center;gap:14px;min-width:0;background:linear-gradient(135deg,rgba(255,255,255,.74),rgba(255,255,255,.52)),url('/MBW-Assets-OG-Image.jpg') center/cover}
...
body[data-page-type="target_bird_tour_builder"] .targetHero h1{margin:0;color:var(--forest);font-size:clamp(2rem,4.2vw,3.55rem);line-height:1.04;letter-spacing:-.025em;max-width:760px}
body[data-page-type="target_bird_tour_builder"] .targetHero p{margin:0;max-width:72ch;color:var(--ink);font-size:1rem;line-height:1.68}
...
body[data-page-type="target_bird_tour_builder"] .targetHeroPanel{display:grid;align-content:stretch}
body[data-page-type="target_bird_tour_builder"] .targetMiniReport{padding:18px;display:grid;gap:12px;align-content:center}
body[data-page-type="target_bird_tour_builder"] .targetMiniReport h2{margin:0;font-size:1.25rem}
body[data-page-type="target_bird_tour_builder"] .targetMiniReport ul{margin:0;padding-left:18px;line-height:1.65;color:var(--ink)}
...
body[data-page-type="target_bird_tour_builder"] .quickToggles{display:flex;gap:8px;flex-wrap:wrap;margin-top:10px}
...
body[data-page-type="target_bird_tour_builder"] .quickToggles button{font-weight:900}
...
body[data-page-type="target_bird_tour_builder"] .targetBirdImage{width:100%;aspect-ratio:4/3;height:auto;object-fit:contain;background:linear-gradient(135deg,rgba(13,89,37,.08),rgba(135,206,235,.10));padding:8px}
...
body[data-page-type="target_bird_tour_builder"] .selectedItem span{display:block;color:var(--muted);font-size:.78rem}
...
body[data-page-type="target_bird_tour_builder"] .payloadPreview{white-space:pre-wrap;max-height:220px;overflow:auto;background:rgba(255,255,255,.72);border:1px solid var(--line);border-radius:14px;padding:10px;font-size:.78rem}
    ...
    <div class="selectedGrid">
      ...
      <div>
        ...
        <form action="/api/target-bird-tour-builder" class="leadForm" data-lead-form id="targetBirdForm" method="post" target="targetBirdHiddenFrame">
          <label><span class="labelText">${isEs ? "Nombre" : "Name"}<span class="req">*</span></span><input name="visitor_name" autocomplete="name" required placeholder="${isEs ? "Nombre" : "Name"}"></label>
          <div class="twoCol">
